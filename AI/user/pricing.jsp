  ...
  <main style="width: min(980px, 100%); margin: 0 auto; padding: 80px 22px;">
    ...
    <section style="text-align: center; margin-bottom: 80px;">
      <div class="user-cards pricing-grid">
        <!-- Starter Plan -->
        <div class="user-card glass-card price-card" style="display: flex; flex-direction: column; height: 100%;">
          <div style="flex: 1;">
            <h3 style="margin-bottom: 12px; font-size: 24px; line-height: 1.16667; font-weight: 600;">Starter</h3>
            <p style="color: var(--text-secondary); font-size: 17px; line-height: 1.47059; margin-bottom: 20px;">1개월 무제한</p>
            <div class="price-display" style="font-size: 32px; line-height: 1.125; font-weight: 600; margin: 20px 0 8px;" data-price-usd="9.99">
              13,487원
            </div>
          ...
          <div style="margin-top: auto; padding-top: 24px; text-align: center;">
            <button class="btn primary" style="width: 100%;" data-plan="STARTER">구독하기</button>
          </div>
        </div>

        <!-- Growth Plan -->
        <div class="user-card glass-card price-card featured" style="border: 2px solid var(--accent); box-shadow: 0 8px 16px var(--shadow-hover); display: flex; flex-direction: column; height: 100%;">
          <div style="flex: 1;">
            <h3 style="margin-bottom: 12px; font-size: 24px; line-height: 1.16667; font-weight: 600;">Growth</h3>
            <p style="color: var(--text-secondary); font-size: 17px; line-height: 1.47059; margin-bottom: 20px;">6개월 무제한</p>
            <div class="price-display" style="font-size: 32px; line-height: 1.125; font-weight: 600; margin: 20px 0 8px;" data-price-usd="49.99">
              67,487원
            </div>
            <div style="font-size: 14px; color: var(--text-secondary); margin-bottom: 24px;">
              ($49.99/6mo)
            ...
            <ul style="list-style: none; padding: 0; margin: 0 0 24px; text-align: left;">
              <li style="padding: 8px 0; font-size: 17px; line-height: 1.47059; color: var(--text);">모든 AI 도구 무제한</li>
              <li style="padding: 8px 0; font-size: 17px; line-height: 1.47059; color: var(--text);">모든 패키지 무제한</li>
              <li style="padding: 8px 0; font-size: 17px; line-height: 1.47059; color: var(--text);">우선 지원</li>
          ...
          <div style="margin-top: auto; padding-top: 24px; text-align: center;">
            <button class="btn primary" style="width: 100%;" data-plan="GROWTH">구독하기</button>
          </div>
        </div>
        ...
        <div class="user-card glass-card price-card" style="display: flex; flex-direction: column; height: 100%;">
          <div style="flex: 1;">
            <h3 style="margin-bottom: 12px; font-size: 24px; line-height: 1.16667; font-weight: 600;">Enterprise</h3>
            <p style="color: var(--text-secondary); font-size: 17px; line-height: 1.47059; margin-bottom: 20px;">1년 무제한</p>
            <div class="price-display" style="font-size: 32px; line-height: 1.125; font-weight: 600; margin: 20px 0 8px;" data-price-usd="99.99">
              134,987원
            </div>
            <div style="font-size: 14px; color: var(--text-secondary); margin-bottom: 24px;">
              ($99.99/yr)
          ...
          <div style="margin-top: auto; padding-top: 24px; text-align: center;">
            <button class="btn primary" style="width: 100%;" data-plan="ENTERPRISE">구독하기</button>
          </div>
        </div>
      </div>
    </section>
